      ...
      <div className="productOverview">
        <div className="productOverview__header">
          <div className="productOverview__imgContainer">
            <img alt="" src="https://p0.meituan.net/deal/e6864ed9ce87966af11d922d5ef7350532676.jpg@450w_280h_1e_1c_1l|watermark=1&&r=1&p=9&x=2&y=2&relative=1&o=20" className="productOverview__img"/>
          </div>
        ...
        <div className="productOverview__purchase">
          ...
          <span className="productOverview__price--old">¥19.9</span>
